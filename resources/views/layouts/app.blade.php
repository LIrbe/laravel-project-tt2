...
<head>
    ...
    <style>
        ...
        #navbar{--bg-opacity:1;background-color:#2d3748;background-color:rgba(45,55,72,var(--bg-opacity))}
        #hlink3{--text-opacity:1;color:#fff;color:rgba(255,255,255,var(--text-opacity))}
        #hlink2{--text-opacity:1;color:#fff;color:rgba(255,255,255,var(--text-opacity))}
        #hlink1{--text-opacity:1;color:#fff;color:rgba(255,255,255,var(--text-opacity))}
    </style>
...
<body>
    ...
    <nav class="navbar navbar-expand-md shadow-sm" id = "navbar">
            <div class="container">
                <a class="navbar-brand" id = "hlink1" href="{{ url('/') }}">
                    {{ config('app.name', 'URMF') }}
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link" id = "hlink2" href="{{ route('login') }}">{{ __('Login') }}</a>
                                </li>
                            @endif

                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" id = "hlink3" href="{{ route('register') }}">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
